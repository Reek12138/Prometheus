...
{
    //初始化ros节点
    ros::init(argc, argv, "uav_control_2");
    ...
    ros::Subscriber sub2 = n.subscribe("/prometheus/drone_state",100,&CurrentStatesListener::callback,&mlistener2);
    ...
    while(ros::ok())
    {
        ...
        command.Reference_State.Move_mode = 3;
        ...
        command.Reference_State.velocity_ref = {vx, 0, 0.0};
        ...
        command.Reference_State.yaw_ref = vyaw;
