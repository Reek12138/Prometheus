...
#define NODE_NAME "my_gimbal_tracking"
#define PI 3.1415926
...
// Eigen::Matrix3f my_get_rotation_matrix(float phi, float theta, float psi)
// {
...
void landpad_det_cb(const prometheus_msgs::DetectionInfo::ConstPtr &msg){
    ...
    if(landpad_det.is_detected == true){
        ...
        pos_gimbal_frame[0] =  landpad_det.Detection_info.position[2];
        pos_gimbal_frame[1] = - landpad_det.Detection_info.position[0];
        pos_gimbal_frame[2] = - landpad_det.Detection_info.position[1];
        ...
        landpad_det.pos_body_frame = R_camera_to_body * pos_gimbal_frame;
    ...
    std::cout<< "pos_body_frame[0] = " << landpad_det.pos_body_frame[0] << " pos_body_frame[1] = " << landpad_det.pos_body_frame[1] << " pos_body_frame[2] = " << landpad_det.pos_body_frame[2] << std::endl;
